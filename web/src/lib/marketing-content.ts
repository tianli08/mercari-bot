...
export const WHAT_IT_DOES_COPY = {
  ...
  features: [
    ...
    { label: "04 UNBOUNDED CATALOG", value: "ANY DESIGNERS" },
  ],
} as const;
...
export const PRESET_CATALOG = [
  { name: "Balenciaga", keyword: "バレンシアガ" },
  { name: "Helmut Lang", keyword: "ヘルムートラング" },
  { name: "Kapital", keyword: "キャピタル" },
  { name: "Undercover", keyword: "アンダーカバー" },
  { name: "Jean Paul Gaultier", keyword: "ジャンポールゴルチエ" },
  { name: "Rick Owens", keyword: "リックオウエンス" },
  { name: "Comme Des Garcons", keyword: "コムデギャルソン" },
  { name: "Vetements", keyword: "ヴェトモン" },
  { name: "Prada", keyword: "プラダ" },
  { name: "Dior Homme", keyword: "ディオールオム" },
  { name: "Ekam", keyword: "エカム" },
  { name: "Chrome Hearts", keyword: "クロムハーツ" },
  { name: "Maison Margiela", keyword: "メゾンマルジェラ" },
  { name: "IfSixWasNine", keyword: "イフシックスワズナイン" },
  { name: "Yohji Yamamoto", keyword: "ヨウジヤマモト" },
  { name: "Number (N)ine", keyword: "ナンバーナイン" },
  { name: "Balmain", keyword: "バルマン" },
  { name: "Acne Studios", keyword: "アクネストゥディオズ" },
  { name: "Saint Laurent", keyword: "サンローラン" },
  { name: "14th Addiction", keyword: "フォーティーンスアディクション" },
  { name: "Dirk Bikkembergs", keyword: "ダークビッケンバーグ" },
  { name: "Givenchy", keyword: "ジバンシィ" },
  { name: "Ann Demeulemeester", keyword: "アンドゥムルメステール" },
  { name: "Supreme", keyword: "シュプリーム" },
  { name: "Kmrii", keyword: "ケムリ" },
  { name: "Celine", keyword: "セリーヌ" },
  { name: "Vivienne Westwood", keyword: "ヴィヴィアンウエストウッド" },
  { name: "Alexander McQueen", keyword: "アレキサンダーマックイーン" },
  { name: "Gucci", keyword: "グッチ" },
  { name: "Raf Simons", keyword: "ラフシモンズ" },
  { name: "Dries Van Noten", keyword: "ドリスヴァンノッテン" },
  { name: "Enfants Riches Deprimes", keyword: "アンファンリッシュデプリメ" },
...
export const PRESETS_COPY = {
  heading: `SAMPLE CATALOG LIST · ANY PRESETS`,
  supportingLine: "CUSTOMIZABLE TO ANY KEYWORDS",
  barcode: "CATALOG20",
} as const;
...
export const SAMPLE_FEED = {
  ...
  rows: [
    ...
    { listing: "JULIUS_7 LEATHER HOLSTER JKT", price: "¥73,800", sold: false, gapSeconds: 267 },
    ...
    { listing: "MARGIELA AW98 FLAT GARMENT TANK", price: "¥64,500", sold: false, gapSeconds: 197 },
    { listing: "MARGIELA 5 ZIP CALF LEATHER JKT", price: "¥158,000", sold: false, gapSeconds: 207 },
    ...
    { listing: "ANN D. FENCING JKT M", price: "¥76,000", sold: false, gapSeconds: 188 },
    { listing: "DIOR HOMME 03 LUSTER DENIM 32", price: "¥112,000", sold: true, gapSeconds: 243 },
    { listing: "SAINT LAURENT 15 TEDDY 46", price: "¥89,000", sold: false, gapSeconds: 156 },
  ],
  soldStamp: "済 SOLD",
} as const;
